/** One selectable row in the phone country-code dropdown. `iso2` is the key
 * (dial codes repeat — the NANP countries all share "+1"), `dialCode` is what
 * gets stored and rendered ahead of the phone number. */
...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  // the option a plain `value="+1"` resolves to — several other NANP
  // countries (Canada included) share that same dial code.
  ...
  { name: "East Timor (Timor-Leste)", iso2: "TL", dialCode: "+670" },
